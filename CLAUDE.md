...
- **Pendiente del usuario (Hito 7)**: habilitar el proveedor Google en Firebase Authentication; añadir los dominios del Codespace (`*-3000.app.github.dev`) y de Vercel a los dominios autorizados de Auth; invitar al resto del grupo; aplicar `firestore.rules` en la consola para cerrar el modo de prueba (después de invitar).
